...
interface A { addToast: (t: Omit<Toast,'id'>) => void; removeToast: (id: string) => void; openModal: (n: string) => void; closeModal: () => void; setMobileSidebar: (v: boolean) => void; }
export const useUIStore = create<S & A>()(immer((set) => ({
  toasts: [], activeModal: null, isMobileSidebarOpen: false,
  addToast: (t) => set(s => { s.toasts.push({ ...t, id: Math.random().toString(36).slice(2) }); }),
